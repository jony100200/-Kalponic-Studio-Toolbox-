@echo off
echo ========================================
echo   KS SnapStudio - Material Preview Tool
echo ========================================
echo.
...
echo Starting KS SnapStudio GUI...
python -m ks_snapstudio.ui.app

pause</content>
<parameter name="filePath">E:\__Kalponic Studio Repositories\-Kalponic-Studio-Toolbox-\Apps\KS SnapStudio\run_snapstudio.bat