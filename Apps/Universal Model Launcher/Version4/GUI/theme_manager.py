...
class ThemeManager(QObject):
    ...
    def get_button_style(self, state='default'):
        """🔘 Get button stylesheet with state-based styling"""
        if state == 'success':
            bg_color = self.colors['status_online']
            text_color = '#ffffff'
            border_color = self.colors['status_online']
        elif state == 'warning':
            bg_color = self.colors['status_loading'] 
            text_color = '#ffffff'
            border_color = self.colors['status_loading']
        elif state == 'danger':
            bg_color = self.colors['status_offline']
            text_color = '#ffffff'
            border_color = self.colors['status_offline']
        else:  # default
            bg_color = self.colors['bg_tertiary']
        ...
        QPushButton:pressed {{
            ...
            border-color: {self.colors['accent_secondary']};
        }}
        
        QPushButton:disabled {{
            background-color: {self.colors['bg_secondary']};
            color: {self.colors['text_muted']};
            border-color: {self.colors['border_primary']};
        }}
        """
