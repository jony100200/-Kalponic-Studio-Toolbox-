...
class RightPanel(QWidget):
    ...
    def _add_initial_logs(self):
        ...
        self.log_display.append(f"{current_time} Universal Model Launcher V4 ready")
    
    def _simulate_performance_update(self):
        """📊 Update performance data from system"""
        # Performance data will be updated via signals from system monitoring
        # This method now just ensures UI stays responsive
        pass
